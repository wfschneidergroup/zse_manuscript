...
\begin{itemize}
\item Rings: 4\(\cdot\)6\textsubscript{13}\(\cdot\)12\(\cdot\)14\textsubscript{7}
\item This work: 4\(\cdot\)6\textsubscript{13}\(\cdot\)12
\item Shortest Path Rings: 4\(\cdot\)6\textsubscript{13}
\item Vertex Symbol Rings: 4\(\cdot\)6\textsubscript{11}
\end{itemize}
...
\hline
ABW & 4\textsubscript{2}\(\cdot\)6\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{2}\(\cdot\)6\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{2}\(\cdot\)6\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{2}\(\cdot\)6\textsubscript{3}\(\cdot\)8\textsubscript{2}\\
ACO & 4\textsubscript{3}\(\cdot\)6\textsubscript{3}\(\cdot\)8\textsubscript{6}\(\cdot\)10\textsubscript{15} & 4\textsubscript{3}\(\cdot\)8\textsubscript{6} & 4\textsubscript{3}\(\cdot\)8\textsubscript{6} & 4\textsubscript{3}\(\cdot\)8\textsubscript{6}\\
AFI & 4\textsubscript{1}\(\cdot\)\textsubscript{13}\(\cdot\)12\textsubscript{1}\(\cdot\)14\textsubscript{7} & 4\textsubscript{1}\(\cdot\)6\textsubscript{13}\(\cdot\)12\textsubscript{1} & 4\textsubscript{1}\(\cdot\)6\textsubscript{13} & 4\textsubscript{1}\(\cdot\)6\textsubscript{11}\\
ANA & 4\textsubscript{2}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{16} & 4\textsubscript{2}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{16} & 4\textsubscript{2}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{16} & 4\textsubscript{2}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{8}\\
ATO & 4\textsubscript{1}\(\cdot\)6\textsubscript{9}\(\cdot\)8\textsubscript{8}\(\cdot\)12\textsubscript{20} & 4\textsubscript{1}\(\cdot\)6\textsubscript{9}\(\cdot\)12\textsubscript{20} & 4\textsubscript{1}\(\cdot\)6\textsubscript{9} & 4\textsubscript{1}\(\cdot\)6\textsubscript{9}\\
BCT & 4\textsubscript{1}\(\cdot\)6\textsubscript{6}\(\cdot\)8\textsubscript{20} & 4\textsubscript{1}\(\cdot\)6\textsubscript{6}\(\cdot\)8\textsubscript{12} & 4\textsubscript{1}\(\cdot\)6\textsubscript{6} & 4\textsubscript{1}\(\cdot\)6\textsubscript{6}\\
CHA & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{6}\(\cdot\)12\textsubscript{1} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2}\(\cdot\)12\textsubscript{1} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2}\\
DFT & 4\textsubscript{2}\(\cdot\)6\textsubscript{6}\(\cdot\)8\textsubscript{10}\(\cdot\)10\textsubscript{10} & 4\textsubscript{2}\(\cdot\)6\textsubscript{6}\(\cdot\)8\textsubscript{10} & 4\textsubscript{2}\(\cdot\)6\textsubscript{6}\(\cdot\)8\textsubscript{10} & 4\textsubscript{2}\(\cdot\)6\textsubscript{4}\(\cdot\)8\textsubscript{6}\\
GIS & 4\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4}\\
GME & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{6}\(\cdot\)12\textsubscript{7} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2}\(\cdot\)12\textsubscript{1} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2} & 4\textsubscript{3}\(\cdot\)6\textsubscript{1}\(\cdot\)8\textsubscript{2}\\
MER & 4\textsubscript{3}\(\cdot\)8\textsubscript{4}\(\cdot\)10\textsubscript{10}\(\cdot\)14\textsubscript{14} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4} & 4\textsubscript{3}\(\cdot\)8\textsubscript{4}\\
MON & 4\textsubscript{1}\(\cdot\)5\textsubscript{5}\(\cdot\)8\textsubscript{6} & 4\textsubscript{1}\(\cdot\)5\textsubscript{5}\(\cdot\)8\textsubscript{6} & 4\textsubscript{1}\(\cdot\)5\textsubscript{5}\(\cdot\)8\textsubscript{6} & 4\textsubscript{1}\(\cdot\)5\textsubscript{4}\(\cdot\)8\textsubscript{4}\\
NPO & 3\textsubscript{1}\(\cdot\)6\textsubscript{6}\(\cdot\)12\textsubscript{40} & 3\textsubscript{1}\(\cdot\)6\textsubscript{6}\(\cdot\)12\textsubscript{40} & 3\textsubscript{1}\(\cdot\)6\textsubscript{6} & 3\textsubscript{1}\(\cdot\)6\textsubscript{6}\\
\hline
\end{tabular}
\begin{tablenotes}
...
\hline
T1 & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{7}\(\cdot\)10\textsubscript{7}\(\cdot\)18\textsubscript{5} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{3} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{3} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\\
T2 & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{7}\(\cdot\)10\textsubscript{7}\(\cdot\)14\textsubscript{5} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{3} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{3} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\\
T3 & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\textsubscript{5}\(\cdot\)10\textsubscript{4}\(\cdot\)12\textsubscript{4}\(\cdot\)14\textsubscript{5} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\(\cdot\)12\textsubscript{4} & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8 & 4\textsubscript{3}\(\cdot\)6\textsubscript{2}\(\cdot\)8\\
T4 & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{6}\(\cdot\)10\textsubscript{6}\(\cdot\)12\(\cdot\)18\textsubscript{26} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{6}\(\cdot\)12 & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{6}\(\cdot\)12 & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{6}\(\cdot\)12\\
T5 & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{7}\(\cdot\)10\textsubscript{6}\(\cdot\)14\textsubscript{18} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{7} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{7} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{7}\\
T6 & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{3}\(\cdot\)10\textsubscript{2}\(\cdot\)12\textsubscript{8}\(\cdot\)14\textsubscript{18} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{3}\(\cdot\)12\textsubscript{8} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{3} & 4\textsubscript{2}\(\cdot\)6\(\cdot\)8\textsubscript{3}\\
\hline
\end{tabular}
\begin{tablenotes}
Vertex symbols have been represented in ring index format for ease of comparison.
...
One final point we would like to make about T-site characterization, is that the vertex symbol and ring indices only provide information about rings, and do not give any information about the spatial orientation of those rings around the T-site. The vertex symbol comes close to accomplishing that, by finding rings associated with opposite edge pairs of the tetrahedron, and then listing the those pairs from smallest to largest. However, the vertex symbol does not capture subtle but distinct differences in the orientation of the rings around the T-site that can lead to varying local void environments. For example: MOR T3, MON T1, and EON T9 all have the same vertex symbol of: 4\codt5\textsubscript{2}\(\cdot\)5\(\cdot\)8\textsubscript{2}\(\cdot\)5\(\cdot\)8\textsubscript{2}. However, the orientation of those rings around each of those T-sites are not identical. \cref{fig:stereo} shows a cutout of each of these frameworks that only includes the atoms that make up the rings of the vertex symbol around the specified T-sites. We can see that MOR T3 and EON T9 have the same ring orientation, and that orientation is different from the rings making up the vertex symbol of MON T1. The main difference is the location of the 5\textsubscript{2}- and 4-MR edges. They are highlighted in \cref{fig:stereo}.
...
With this new descriptor MOR T3 and EON T9 would be labeled as: 8\textsubscript{2}\(\cdot\)8\textsubscript{2}\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)4\(\cdot\)5, and MON T1 as: 8\textsubscript{2}\(\cdot\)8\textsubscript{2}\(\cdot\)4\(\cdot\)5\(\cdot\)5\textsubscript{2}\(\cdot\)5. The difference is subtle but highlights the distinct structural difference between the two types of T-sites that is not otherwise captured by a vertex symbol. Stereochemistry of the rings associated with a T-site could influence the chemical properties we care about such as deprotonation energy, T-site substitution energy, or catalytic properties of reactions happening at that T-site.
...
\hline
5\(\cdot\)5\(\cdot\)5\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)10 & EWS T3 & 10\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & ITN T9 & 10\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & ITN T21 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & OKO T2 & 10\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & OKO T5 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & PCS T2 & 10\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & PCS T3 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & SFS T10 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & SFV T3 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & SFV T7 & 5\textsubscript{2}\(\cdot\)10\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
 & TUN T10 & 10\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)5\(\cdot\)5\(\cdot\)5\\
\hline
4\(\cdot\)5\textsubscript{2}\(\cdot\)5\(\cdot\)8\(\cdot\)5\(\cdot\)8 & DAC T3 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
 & DAC T4 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
 & EON T10 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
 & EPI T1 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
 & MOR T4 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
 & RSN T4 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)8\(\cdot\)4\\
 & VNI T2 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)8\(\cdot\)4\\
 & VSV T2 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)8\(\cdot\)4\\
 & YFI T9 & 5\textsubscript{2}\(\cdot\)8\(\cdot\)8\(\cdot\)5\(\cdot\)5\(\cdot\)4\\
\hline
