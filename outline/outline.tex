...
\label{sec:org061dd26}
\begin{itemize}
\item Zeolites can naturally be represented using graph theory, where atoms are nodes, and bonds are edges.
\begin{itemize}
...
\begin{itemize}
\item This ring finding rules often find rings that are not discussed in literature, and are not listed by the IZA
