...
Note that in \Cref{fig:tsite-frequency} a bar for IZA rings is not present. This is because the IZA does not list rings that pass through specific T-sites.
